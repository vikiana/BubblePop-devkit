...
exports = Class(GC.Application, function () {
    ...
    this.initUI = function () {
      ...
      this.view.style.backgroundColor = '#aaf7ff';
		...
		var welcomescreen = new WelcomeScreen({width: rootView.style.width, height: rootView.style.height}),
		gamescreen = new GameScreen({width: rootView.style.width, height: rootView.style.height});
